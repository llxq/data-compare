...
declare const createCompareNode: <T extends CompareDataAttr = CompareData>(data: CreateCompareTreeProps<T>, parent?: CompareTree<T> | undefined, isClone?: boolean) => CompareTree<T>
declare const speedCreateCompareNode: <T extends CompareDataAttr = CompareData>(data: T, parent?: CompareTree<T> | undefined) => CompareTree<T>
declare const diffCompareTree: {
...
declare const speedDiffStatus: <T extends CompareDataAttr = CompareData>(current: T, online: T, base: T) => SpeedDiffStatusType
declare const diffAttr: (origin: unknown, target: unknown, pathStacks?: string[]) => AttrCompareStatus<CompareDataAttr>
declare const parse: {
...
declare const updateConfig: (config: Partial<DataCompareConfig>) => void
